...
.project-card--inflation::after {
  background:
    linear-gradient(115deg, transparent 46%, rgba(229,72,77,.12)),
    repeating-linear-gradient(
      90deg,
      transparent 0 46px,
      rgba(255,255,255,.055) 46px 47px
    );
}
.project-card--launch::after {
  background:
    radial-gradient(ellipse at 82% 78%, rgba(229,72,77,.22), transparent 17%),
    linear-gradient(142deg, transparent 59%, rgba(255,255,255,.07) 59.2%, transparent 59.6%),
    repeating-radial-gradient(
      circle at 82% 78%,
...
.project-card--cyber::after {
  background:
    linear-gradient(90deg, transparent 49.8%, rgba(229,72,77,.20) 50%, transparent 50.2%),
    linear-gradient(0deg, transparent 49.8%, rgba(255,255,255,.08) 50%, transparent 50.2%),
    repeating-radial-gradient(
      circle at 76% 70%,
      rgba(229,72,77,.14) 0 1px,
